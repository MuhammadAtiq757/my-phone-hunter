...
const displayPhoneDetails = phone =>{
  console.log(phone)
  const modalTitle = document.getElementById('phone-detail-modalLabel');
...
<p>Main Features: ${phone.mainFeatures.storage ? phone.mainFeatures.storage : 'No main Features Information'}

<img class="mt-5 ps-5" src="${phone.image}">
